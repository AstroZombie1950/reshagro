...
<head>
	...
	<title>Strunjire și Frezare CNC la Comandă | Producție Piese Mecanice | Reshagro Engineering Center</title>
	<meta name="description" content="Servicii de strunjire și frezare CNC pentru piese din metal și plastic. Producție pe baza desenelor tehnice, prototipuri și serii, suport tehnic și ingineresc. Colaborare la nivel european.">
	<meta name="keywords" content="strunjire CNC, frezare CNC, prelucrare mecanică, producție piese metalice, servicii CNC, producție de serie, prototipuri industriale, subcontractare industrială">
	<meta name="author" content="Reshagro Engineering Center">
	<meta name="robots" content="index, follow">
	<meta name="theme-color" content="#0e5fa8">
	<!-- Canonical -->
	<link rel="canonical" href="https://reshagro.com/ro/">
	<!-- Hreflang -->
	...
	<meta property="og:title" content="Strunjire și Frezare CNC | Reshagro">
	<meta property="og:description" content="Prelucrare CNC de înaltă precizie pe baza documentației tehnice. Producție unitară și de serie.">
	<meta property="og:url" content="https://reshagro.com/ro/">
	<meta property="og:image" content="https://reshagro.com/img/logo_ogimg.png">
	<meta property="og:locale" content="ro_RO">
	<!-- Twitter Card -->
	<meta name="twitter:card" content="summary_large_image">
	<meta name="twitter:title" content="Strunjire și Frezare CNC | Reshagro">
	<meta name="twitter:description" content="Servicii CNC de precizie pentru piese metalice și din plastic.">
...
<body>
		...
		<div class="container">
			<div class="header__inner">
				...
				<nav class="nav" id="nav">
					<a href="#about" class="nav__link">Despre noi</a>
					<a href="#equipment" class="nav__link">Echipamente</a>
					<a href="#services" class="nav__link">Servicii</a>
					<a href="#projects" class="nav__link">Proiectele noastre</a>
					<button class="btn btn-primary btn-nav" id="openModal">Solicită ofertă</button>
				</nav>
				...
				<button class="btn btn-primary btn-head" id="openModal">Solicită ofertă</button>
			</div>
		</div>
	</header>
	<!-- hero -->
	<section class="hero" id="about">
		...
		<div class="container">
			<div class="hero__content hero__content--animate">
				<h1 class="hero__title">Prelucrare prin strunjire și frezare a metalelor la comandă</h1>
				<div class="hero__underline"></div>
				<p class="hero__text">Compania Reshagro oferă clienților săi servicii de frezare a metalelor la comandă<br>În unitățile noastre de producție sunt disponibile utilaje universale și mașini CNC pentru operațiuni de frezare. Se realizează frezare orizontală și verticală cu precizie până la clasa IT6. Lucrăm cu oțeluri carbon, metale neferoase și oțeluri inoxidabile. Prelucrare mecanică de înaltă precizie a pieselor conform desenelor tehnice. Producție de serie și unicat pentru companii și clienți individuali.</p>
			</div>
		</div>
	</section>
	<!-- adv -->
			...
			<div class="stats__grid">
				<div class="stats__card">
					...
					<div class="stats__content">
						<p class="stats__label">Activăm din</p>
						<h3>2018</h3>
					</div>
				</div>
				<div class="stats__card">
					...
					<div class="stats__overlay"></div>
					<div class="stats__content">
						<p class="stats__label">Experiența medie a specialiștilor</p>
						<h3>15 ANI</h3>
					</div>
				</div>
				<div class="stats__card">
					...
					<div class="stats__overlay"></div>
					<div class="stats__content">
						<p class="stats__label">Devine partener permanent</p>
						<h3>75% CLIENȚI</h3>
					</div>
				</div>
				<div class="stats__card">
					...
					<div class="stats__overlay"></div>
					<div class="stats__content">
						<p class="stats__label">Disponibil peste</p>
						<h3>45 UTILAJE</h3>
					</div>
				</div>
				<div class="stats__card">
					...
					<div class="stats__overlay"></div>
					<div class="stats__content">
						<p class="stats__label">Peste</p>
						<h3>1000 COMENZI FINALIZATE</h3>
					</div>
				</div>
			</div>
		</div>
	...
	<section class="equipment reveal" id="equipment">
		...
		<div class="equipment__header">
			<div class="container_eq">
				<h2 class="equipment__heading">ECHIPAMENTE</h2>
			</div>
		</div>
		...
		<div class="equipment__content">
			<div class="container equipment__content-inner">
				<div class="equipment__text">
					<h3>
						FABRICARE PE BAZA DESENELOR<br>
						SAU MOSTRELOR DVS.
					</h3>
					<p>
						Ne puteți furniza o piesă metalică și puteți comanda realizarea unui duplicat.
						Efectuăm toate măsurătorile necesare, elaborăm desenul tehnic și fabricăm piesa solicitată.
					</p>
				</div>
				<div class="equipment__cta">
					<button class="btn btn-primary">CALCUL<br>COST COMANDĂ</button>
				</div>
			</div>
		</div>
	</section>
		...
		<div class="container">
			...
			<div class="services__grid">
				<div class="service-card service-card--1">
					...
					<h3>Prelucrare prin strunjire și frezare a metalelor și materialelor plastice</h3>
					<p>Prelucrare mecanică de înaltă precizie pe echipamente moderne.</p>
					<button class="btn btn-primary">de la 10 € / buc.</button>
				</div>
				<div class="service-card service-card--2">
					<div class="service-card__bg"></div>
					<h3>Fabricarea pieselor la comandă conform desenelor</h3>
					<p>Producție pe baza documentației tehnice și a mostrelor furnizate.</p>
					<button class="btn btn-primary">de la 5 € / buc.</button>
				</div>
				<div class="service-card service-card--3">
					<div class="service-card__bg"></div>
					<h3>Producție de serie și unicat</h3>
					<p>Fabricarea loturilor de piese în orice volum.</p>
					<button class="btn btn-primary">de la 15 € / buc.</button>
				</div>
				<div class="service-card service-card--4">
					<div class="service-card__bg"></div>
					<h3>Consultanță inginerească și tehnologică</h3>
					<p>Selectarea soluțiilor optime și suport pe parcursul proiectului.</p>
					<button class="btn btn-primary">de la 12 € / buc.</button>
				</div>
				<div class="service-card service-card--5">
					<div class="service-card__bg"></div>
					<h3>Operațiuni de asamblare și procese secundare</h3>
					<p>Prelucrare complexă și pregătirea produselor finite.</p>
					<button class="btn btn-primary">de la 8 € / buc.</button>
				</div>
				<div class="service-card--6">
					<div class="service-card__bg"></div>
					<h3>Comandă personalizată</h3>
					<p>Dezvoltarea și implementarea proiectelor нестандартe.</p>
					<button class="btn btn-primary">Contactați-ne</button>
				</div>
			</div>
		</div>
	</section>
		...
		<div class="container">
			<div class="work-types__grid">
				<div class="work-types__content">
					<h2 class="t30 fw7 mb2">Tipuri de lucrări de frezare</h2>
					<p class="t16 mb3">Operațiunile de frezare sunt utilizate pentru prelucrarea diferitelor suprafețe și pentru realizarea unei game largi de procese:</p>
					<ul class="work-types__list mb3">
						<li>Prelucrarea suprafețelor plane;</li>
						<li>Realizarea canalelor și șanțurilor;</li>
						<li>Executarea treptelor;</li>
						<li>Formarea suprafețelor profilate;</li>
						<li>Filetare;</li>
						<li>Fabricarea roților dințate.</li>
					</ul>
					<p class="t16 mb2">Pentru aceste operațiuni se utilizează diferite tipuri de freze:</p>
					<ol class="work-types__list work-types__list--numbered">
						<li><strong>Cilindrice</strong> — pentru prelucrarea suprafețelor plane;</li>
						<li><strong>Frontale</strong> — pentru frezarea planurilor și treptelor;</li>
						<li><strong>Discuri</strong> — pentru realizarea canalelor și debitarea metalului;</li>
						<li><strong>Deget</strong> — tip universal pentru diverse operațiuni;</li>
						<li><strong>Unghiulare</strong> — pentru prelucrarea suprafețelor înclinate;</li>
						<li><strong>Profilate</strong> — pentru realizarea suprafețelor cu forme complexe.</li>
					</ol>
					<p class="t16 mb2">Alegerea tipului de freză depinde direct de natura lucrărilor și de precizia de prelucrare necesară.</p>
				</div>
	...
	<section class="projects ba-block reveal" id="projects">
		<div class="container">
			<h2 class="t30 fw7 mb3">Proiectele noastre</h2>
			<!-- ===== Desktop Slider ===== -->
			<div class="projects-slider">
				<button class="projects-arrow projects-arrow--prev" aria-label="Înapoi">
				...
				<button class="projects-arrow projects-arrow--next" aria-label="Înainte">
					<svg viewBox="0 0 24 24" width="28" height="28">
	...
	<section class="contact reveal">
		<div class="container">
			<h2 class="section-title contact__title">Trimiteți proiectul pentru ofertare</h2>
			<form id="projectForm" class="contact-form" enctype="multipart/form-data" novalidate>
				<div class="contact-form__content">
					<div class="contact-form__row">
						<input type="text" name="name" placeholder="Nume" requiredpattern="^[A-Za-zА-Яа-яЁё\s]+$">
					...
					<div class="contact-form__upload">
						<label class="upload-box">
							...
							<div class="upload-text">
								<p class="upload-title">Adăugați desenul tehnic</p>
								<p class="upload-sub">Faceți clic pentru a selecta fișierul</p>
							</div>
						</label>
						<div class="file-list"></div>
						<div class="warning">
							<p class="warning-text">Se pot încărca maximum 10 fișiere.</p>
						</div>
					</div>
					<textarea name="message" placeholder="Descrieți materialul, volumul, cantitatea și detaliile"></textarea>
					<div class="contact-form__captcha">
						<label>Cât este <?php echo $a; ?> + <?php echo $b; ?>?</label>
				...
				<div class="footer-links">
					<div class="footer-col">
						...
						<div class="footer-sub">
							<p class="footer-label">Adresă juridică și operațională</p>
	...
	<div class="rg-modal" id="projectModal" aria-hidden="true">
		...
		<div class="rg-modal__window" role="dialog" aria-modal="true">
			...
			<h3 class="rg-modal__title">Solicită ofertă</h3>
			<p class="modal_desc">Trimiteți detaliile proiectului, iar noi vom pregăti oferta în cel mai scurt timp</p>
			<form id="projectFormModal" class="contact-form contact-form--modal" enctype="multipart/form-data">
				<div class="contact-form__content-modal">
					<div class="contact-form__row-modal">
						<input type="text" name="name" placeholder="Nume" required pattern="^[A-Za-zА-Яа-яЁё\s]+$">
						<input type="email" name="email" placeholder="Email" required>
					</div>
					<textarea class="text_modal" name="message" placeholder="Descrieți pe scurt cerința"></textarea>
					<div class="contact-form__upload">
						<label class="upload-box">
							<input type="file" name="files[]" multiple hidden accept=".zip,.jpg,.jpeg,.png,.docx,.xlsx,.pdf,.dxf,.dwg">
							<div class="upload-icon">
								<img src="/img/upload.svg" alt="Încărcare fișier" width="48" height="48">
							</div>
							<div class="upload-text">
								<p class="upload-title">Adăugați desenul tehnic</p>
								<p class="upload-sub">Faceți clic pentru a selecta fișierul</p>
					...
					<input type="text" name="company" style="display:none" autocomplete="off">
					<button class="modal_submit_btn" type="submit">Trimiteți</button>
				</div>
	...
	const ReshagroModal = (function() {
		...
		const modalContent = {
			default: {
				...
				desc: 'Trimiteți detaliile proiectului, iar noi vom pregăti oferta în cel mai scurt timp'
			},
			auto: {
				title: 'Aveți întrebări?',
				desc: 'Lăsați o solicitare, iar noi vă vom oferi consultanță gratuită'
			}
		};
	...
	<script src="/js/ro/modal.js"></script>
	<script src="/js/ro/form.js"></script>
</body>
</html>