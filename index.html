...
<head>
	...
	<title>CNC Turning & Milling Services | Custom Metal Parts Manufacturing | Reshagro Engineering Center</title>
	<meta name="description" content="Custom CNC turning and milling services for metal and plastic parts. Manufacturing based on technical drawings, prototype and serial production, engineering support. Operating across Europe.">
	<meta name="keywords" content="CNC turning, CNC milling, custom metal machining, precision parts manufacturing, CNC machining services, prototype production, serial production">
	<meta name="author" content="Reshagro Engineering Center">
	<meta name="robots" content="index, follow">
	<meta name="theme-color" content="#0e5fa8">
	<!-- Canonical -->
	<link rel="canonical" href="https://reshagro.com/">
	<!-- Hreflang -->
	...
	<meta property="og:title" content="CNC Turning & Milling Services | Reshagro">
	<meta property="og:description" content="High-precision CNC machining of metal and plastic parts based on technical drawings. Prototype and serial production.">
	<meta property="og:url" content="https://reshagro.com/">
	<meta property="og:image" content="https://reshagro.com/img/logo_ogimg.png">
	<meta property="og:locale" content="en_US">
	<!-- Twitter Card -->
	<meta name="twitter:card" content="summary_large_image">
	<meta name="twitter:title" content="CNC Turning & Milling Services | Reshagro">
	<meta name="twitter:description" content="High-precision CNC machining of custom parts.">
...
<body>
		...
		<div class="container">
			<div class="header__inner">
				...
				<nav class="nav" id="nav">
					...
					<a href="#projects" class="nav__link">Our Projects</a>
					<button class="btn btn-primary btn-nav" id="openModal">Get a Quote</button>
				</nav>
				...
				<button class="btn btn-primary btn-head" id="openModal">Get a Quote</button>
			</div>
		</div>
	</header>
	<!-- hero -->
	<section class="hero" id="about">
		...
		<div class="container">
			<div class="hero__content hero__content--animate">
				<h1 class="hero__title">Custom Metal Turning and Milling Services</h1>
				<div class="hero__underline"></div>
				<p class="hero__text">Reshagro provides professional custom metal milling services for its clients<br>Our production facilities are equipped with universal and CNC milling machines. We perform both horizontal and vertical milling with precision up to IT6 tolerance grade. The company works with carbon steel, non-ferrous and stainless metals. High-precision machining of parts based on technical drawings. We offer both batch and one-off production for industrial enterprises and private customers.</p>
			</div>
		</div>
	</section>
	<!-- adv -->
			...
			<div class="stats__grid">
				<div class="stats__card">
					...
					<div class="stats__content">
						<p class="stats__label">Operating Since</p>
						<h3>2018</h3>
					</div>
				</div>
				<div class="stats__card">
					...
					<div class="stats__overlay"></div>
					<div class="stats__content">
						<p class="stats__label">Average Specialist Experience</p>
						<h3>15 YEARS</h3>
					</div>
				</div>
				<div class="stats__card">
					...
					<div class="stats__overlay"></div>
					<div class="stats__content">
						<p class="stats__label">Become Returning</p>
						<h3>75% OF CLIENTS</h3>
					</div>
				</div>
				<div class="stats__card">
					...
					<div class="stats__overlay"></div>
					<div class="stats__content">
						<p class="stats__label">Over</p>
						<h3>45 UNITS OF EQUIPMENT</h3>
					</div>
				</div>
				<div class="stats__card">
					...
					<div class="stats__overlay"></div>
					<div class="stats__content">
						<p class="stats__label">Completed Over</p>
						<h3>1000 ORDERS</h3>
					</div>
				</div>
			</div>
	...
	<section class="equipment reveal" id="equipment">
		...
		<div class="equipment__header">
			<div class="container_eq">
				<h2 class="equipment__heading">EQUIPMENT</h2>
			</div>
		</div>
		...
		<div class="equipment__content">
			<div class="container equipment__content-inner">
				<div class="equipment__text">
					<h3>
						MANUFACTURING BASED ON YOUR DRAWINGS<br>
						OR SAMPLES
					</h3>
					<p>
						You can provide us with a metal part and request a duplicate.
						We will take all necessary measurements, create technical drawings, and manufacture the required component.
					</p>
				</div>
				<div class="equipment__cta">
					<button class="btn btn-primary">GET A<br>QUOTE</button>
				</div>
			</div>
		</div>
	</section>
		...
		<div class="container">
			...
			<div class="services__grid">
				<div class="service-card service-card--1">
					...
					<h3>Turning and Milling of Metals and Plastics</h3>
					<p>High-precision machining using modern equipment.</p>
					<button class="btn btn-primary">from €10 per unit</button>
				</div>
				<div class="service-card service-card--2">
					<div class="service-card__bg"></div>
					<h3>Custom Part Manufacturing Based on Drawings</h3>
					<p>Production according to your technical specifications and samples.</p>
					<button class="btn btn-primary">from €5 per unit</button>
				</div>
				<div class="service-card service-card--3">
					<div class="service-card__bg"></div>
					<h3>Batch and One-off Production</h3>
					<p>Manufacturing of parts in any required volume.</p>
					<button class="btn btn-primary">from €15 per unit</button>
				</div>
				<div class="service-card service-card--4">
					<div class="service-card__bg"></div>
					<h3>Engineering and Technical Consulting</h3>
					<p>Selection of optimal solutions and full project support.</p>
					<button class="btn btn-primary">from €12 per unit</button>
				</div>
				<div class="service-card service-card--5">
					<div class="service-card__bg"></div>
					<h3>Assembly and Secondary Operations</h3>
					<p>Comprehensive processing and finishing of components.</p>
					<button class="btn btn-primary">from €8 per unit</button>
				</div>
				<div class="service-card--6">
					<div class="service-card__bg"></div>
					<h3>Custom Orders</h3>
					<p>Development and implementation of non-standard projects.</p>
		...
		<div class="container">
			<div class="work-types__grid">
				<div class="work-types__content">
					<h2 class="t30 fw7 mb2">Types of Milling Operations</h2>
					<p class="t16 mb3">Milling operations are used for machining various surfaces and performing a wide range of processes:</p>
					<ul class="work-types__list mb3">
						<li>Machining flat surfaces;</li>
						<li>Cutting slots and grooves;</li>
						<li>Producing shoulders;</li>
						<li>Forming contoured surfaces;</li>
						<li>Thread cutting;</li>
						<li>Manufacturing gears.</li>
					</ul>
					<p class="t16 mb2">Different types of milling cutters are used to perform these operations:</p>
					<ol class="work-types__list work-types__list--numbered">
						<li><strong>Cylindrical</strong> — for machining flat surfaces;</li>
						<li><strong>Face</strong> — for milling planes and shoulders;</li>
						<li><strong>Slitting</strong> — for cutting slots and separating metal;</li>
						<li><strong>End</strong> — a versatile type for various operations;</li>
						<li><strong>Angle</strong> — for machining inclined surfaces;</li>
						<li><strong>Form</strong> — for creating complex-shaped surfaces.</li>
					</ol>
					<p class="t16 mb2">The selection of a milling cutter type directly depends on the nature of the operation and the required machining accuracy.</p>
				</div>
	...
	<section class="projects ba-block reveal" id="projects">
		<div class="container">
			<h2 class="t30 fw7 mb3">PROJECTS</h2>
			<!-- ===== Desktop Slider ===== -->
			<div class="projects-slider">
				<button class="projects-arrow projects-arrow--prev" aria-label="Previous">
				...
				<button class="projects-arrow projects-arrow--next" aria-label="Next">
					<svg viewBox="0 0 24 24" width="28" height="28">
					...
					<div class="contact-form__upload">
						<label class="upload-box">
							...
							<div class="upload-text">
								<p class="upload-title">Add Technical Drawing</p>
								<p class="upload-sub">Click to select files</p>
							</div>
						</label>
						<div class="file-list"></div>
						<div class="warning">
							<p class="warning-text">You can upload up to 10 files.</p>
						</div>
					</div>
				...
				<div class="footer-links">
					<div class="footer-col">
						...
						<div class="footer-sub">
							<p class="footer-label">Registered and Operating Address</p>
	...
	<div class="rg-modal" id="projectModal" aria-hidden="true">
		...
		<div class="rg-modal__window" role="dialog" aria-modal="true">
			...
			<h3 class="rg-modal__title">GET A QUOTE</h3>
			<p class="modal_desc">Send us your project details, and we will prepare a cost estimate as quickly as possible</p>
			<form id="projectFormModal" class="contact-form contact-form--modal" enctype="multipart/form-data">
				<div class="contact-form__content-modal">
					...
					<textarea class="text_modal" name="message" placeholder="Briefly describe your project"></textarea>
					<div class="contact-form__upload">
						<label class="upload-box">
							<input type="file" name="files[]" multiple hidden accept=".zip,.jpg,.jpeg,.png,.docx,.xlsx,.pdf,.dxf,.dwg">
							<div class="upload-icon">
								<img src="/img/upload.svg" alt="File Upload" width="48" height="48">
							</div>
							<div class="upload-text">
								<p class="upload-title">Add Technical Drawing</p>
								<p class="upload-sub">Click to select files</p>
					...
					<input type="text" name="company" style="display:none" autocomplete="off">
					<button class="modal_submit_btn" type="submit">Submit</button>
				</div>
	...
	const ReshagroModal = (function() {
		...
		const modalContent = {
			default: {
				title: 'GET A QUOTE',
				desc: 'Send us your project details, and we will prepare a cost estimate as quickly as possible'
			},
			auto: {
				title: 'Have Any Questions?',
				desc: 'Leave a request, and we will provide you with a free consultation'
			}
		};
