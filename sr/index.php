...
<head>
	...
	<title>CNC Tokarenje i Glodanje po Crtežu | Proizvodnja Mašinskih Delova | Reshagro Engineering Center</title>
	<meta name="description" content="CNC tokarenje i glodanje metalnih i plastičnih delova prema tehničkoj dokumentaciji. Prototipovi i serijska proizvodnja, inženjerska podrška. Saradnja širom Evrope.">
	<meta name="keywords" content="CNC tokarenje, CNC glodanje, mašinska obrada, proizvodnja metalnih delova, precizna obrada, serijska proizvodnja, industrijski podizvođač">
	<meta name="author" content="Reshagro Engineering Center">
	<meta name="robots" content="index, follow">
	<meta name="theme-color" content="#0e5fa8">
	<!-- Canonical -->
	<link rel="canonical" href="https://reshagro.com/sr/">
	<!-- Hreflang -->
	...
	<meta property="og:title" content="CNC Tokarenje i Glodanje | Reshagro">
	<meta property="og:description" content="Visokoprecizna CNC obrada prema tehničkoj dokumentaciji. Prototipovi i serijska proizvodnja.">
	<meta property="og:url" content="https://reshagro.com/sr/">
	<meta property="og:image" content="https://reshagro.com/img/logo_ogimg.png">
	<meta property="og:locale" content="sr_RS">
	<!-- Twitter Card -->
	<meta name="twitter:card" content="summary_large_image">
	<meta name="twitter:title" content="CNC Tokarenje i Glodanje | Reshagro">
	<meta name="twitter:description" content="Precizna CNC obrada metalnih i plastičnih delova.">
...
<body>
		...
		<div class="container">
			<div class="header__inner">
				...
				<nav class="nav" id="nav">
					...
					<a href="#equipment" class="nav__link">Oprema</a>
					<a href="#services" class="nav__link">Usluge</a>
					<a href="#projects" class="nav__link">Naši projekti</a>
					<button class="btn btn-primary btn-nav" id="openModal">Zatražite ponudu</button>
				</nav>
				...
				<button class="btn btn-primary btn-head" id="openModal">Zatražite ponudu</button>
			</div>
		</div>
	</header>
	<!-- hero -->
	<section class="hero" id="about">
		...
		<div class="container">
			<div class="hero__content hero__content--animate">
				<h1 class="hero__title">Tokarska i glodačka obrada metala po narudžbini</h1>
				<div class="hero__underline"></div>
				<p class="hero__text">Kompanija Reshagro svojim klijentima nudi uslugu — glodačku obradu metala po narudžbini<br>Na našim proizvodnim lokacijama raspolažemo univerzalnim mašinama i CNC obradnim centrima za glodanje. Izvodimo horizontalno i vertikalno glodanje sa preciznošću do 6. kvaliteta. Radimo sa čeličnim, obojenim i nerđajućim metalima. Visokoprecizna mehanička obrada delova prema tehničkim crtežima. Serijska i pojedinačna proizvodnja za preduzeća i privatne klijente.</p>
			</div>
		</div>
	</section>
	<!-- adv -->
			...
			<div class="stats__grid">
				<div class="stats__card">
					...
					<div class="stats__content">
						<p class="stats__label">Poslujemo od</p>
						<h3>2018. GODINE</h3>
					</div>
				</div>
				<div class="stats__card">
					...
					<div class="stats__overlay"></div>
					<div class="stats__content">
						<p class="stats__label">Prosečno iskustvo stručnjaka</p>
						<h3>15 GODINA</h3>
					</div>
				</div>
				<div class="stats__card">
					...
					<div class="stats__overlay"></div>
					<div class="stats__content">
						<p class="stats__label">Postaju stalni</p>
						<h3>75% KLIJENATA</h3>
					</div>
				</div>
				<div class="stats__card">
					...
					<div class="stats__overlay"></div>
					<div class="stats__content">
						<p class="stats__label">Raspolažemo sa više od</p>
						<h3>45 JED. OPREME</h3>
					</div>
				</div>
				<div class="stats__card">
					...
					<div class="stats__overlay"></div>
					<div class="stats__content">
						<p class="stats__label">Realizovano više od</p>
						<h3>1000 PORUDŽBINA</h3>
					</div>
				</div>
			</div>
		</div>
	...
	<section class="equipment reveal" id="equipment">
		...
		<div class="equipment__header">
			<div class="container_eq">
				<h2 class="equipment__heading">OPREMA</h2>
			</div>
		</div>
		...
		<div class="equipment__content">
			<div class="container equipment__content-inner">
				<div class="equipment__text">
					<h3>
						IZRADA PREMA VAŠIM TEHNIČKIM CRTEŽIMA<br>
						ILI UZORCIMA
					</h3>
					<p>
						Možete nam dostaviti metalni deo i naručiti izradu duplikata.
						Izvršićemo sva potrebna merenja, izraditi tehnički crtež i proizvesti traženi deo.
					</p>
				</div>
				<div class="equipment__cta">
					<button class="btn btn-primary">Zatražite<br>PONUDU</button>
				</div>
			</div>
		</div>
	</section>
	...
	<section class="services services--animate reveal" id="services">
		<div class="container">
			<h2 class="services__title">USLUGE</h2>
			<div class="services__grid">
				<div class="service-card service-card--1">
					<div class="service-card__bg"></div>
					<h3>Tokarska i glodačka obrada metala i plastike</h3>
					<p>Visokoprecizna mehanička obrada na savremenoj opremi.</p>
					<button class="btn btn-primary">od 10 € po kom.</button>
				</div>
				<div class="service-card service-card--2">
					<div class="service-card__bg"></div>
					<h3>Izrada delova po narudžbini prema tehničkim crtežima</h3>
					<p>Proizvodnja prema vašoj tehničkoj dokumentaciji i uzorcima.</p>
					<button class="btn btn-primary">od 5 € po kom.</button>
				</div>
				<div class="service-card service-card--3">
					<div class="service-card__bg"></div>
					<h3>Serijska i pojedinačna proizvodnja</h3>
					<p>Izrada serija delova svih obima.</p>
					<button class="btn btn-primary">od 15 € po kom.</button>
				</div>
				<div class="service-card service-card--4">
					<div class="service-card__bg"></div>
					<h3>Inženjerske i tehnološke konsultacije</h3>
					<p>Izbor optimalnih rešenja i stručna podrška tokom realizacije projekta.</p>
					<button class="btn btn-primary">od 12 € po kom.</button>
				</div>
				<div class="service-card service-card--5">
					<div class="service-card__bg"></div>
					<h3>Montažne i sekundarne operacije</h3>
					<p>Kompleksna obrada i priprema proizvoda.</p>
					<button class="btn btn-primary">od 8 € po kom.</button>
				</div>
				<div class="service-card--6">
					<div class="service-card__bg"></div>
					<h3>Individualna porudžbina</h3>
					<p>Razvoj i realizacija nestandardnih zadataka.</p>
					<button class="btn btn-primary">Kontaktirajte nas</button>
				</div>
			</div>
		</div>
	</section>
		...
		<div class="container">
			<div class="work-types__grid">
				<div class="work-types__content">
					<h2 class="t30 fw7 mb2">Vrste glodačkih radova</h2>
					<p class="t16 mb3">Glodački radovi se koriste za obradu različitih površina i izvođenje širokog spektra operacija:</p>
					<ul class="work-types__list mb3">
						<li>Obrada ravnih površina;</li>
						<li>Izrada žlebova i kanala;</li>
						<li>Izrada stepenica i ramena;</li>
						<li>Formiranje profilisanih površina;</li>
						<li>Narezivanje navoja;</li>
						<li>Izrada zupčanika.</li>
					</ul>
					<p class="t16 mb2">Za izvođenje ovih operacija koriste se različite vrste glodala:</p>
					<ol class="work-types__list work-types__list--numbered">
						<li><strong>Cilindrična</strong> — za obradu ravnih površina;</li>
						<li><strong>Čeona</strong> — za glodanje ravni i stepenica;</li>
						<li><strong>Diskasta</strong> — za izradu žlebova i sečenje metala;</li>
						<li><strong>Krajnja</strong> — univerzalni tip za različite operacije;</li>
						<li><strong>Ugaona</strong> — za obradu kosih površina;</li>
						<li><strong>Profilna</strong> — za izradu složenih oblika.</li>
					</ol>
					<p class="t16 mb2">Izbor tipa glodala direktno zavisi od karaktera operacije i zahtevanog nivoa preciznosti obrade.</p>
				</div>
	...
	<section class="projects ba-block reveal" id="projects">
		<div class="container">
			<h2 class="t30 fw7 mb3">Naši projekti</h2>
			<!-- ===== Desktop Slider ===== -->
			<div class="projects-slider">
				<button class="projects-arrow projects-arrow--prev" aria-label="Nazad">
				...
				<button class="projects-arrow projects-arrow--next" aria-label="Napred">
					<svg viewBox="0 0 24 24" width="28" height="28">
	...
	<section class="contact reveal">
		<div class="container">
			<h2 class="section-title contact__title">Pošaljite projekat za obračun</h2>
			<form id="projectForm" class="contact-form" enctype="multipart/form-data" novalidate>
				<div class="contact-form__content">
					<div class="contact-form__row">
						<input type="text" name="name" placeholder="Ime" requiredpattern="^[A-Za-zА-Яа-яЁё\s]+$">
					...
					<div class="contact-form__upload">
						<label class="upload-box">
							...
							<div class="upload-text">
								<p class="upload-title">Dodajte tehnički crtež</p>
								<p class="upload-sub">Kliknite da izaberete fajl</p>
							</div>
						</label>
						<div class="file-list"></div>
						<div class="warning">
							<p class="warning-text">Možete otpremiti najviše 10 fajlova.</p>
						</div>
					</div>
					<textarea name="message" placeholder="Opišite materijal, obim, količinu i tehničke zahteve"></textarea>
					<div class="contact-form__captcha">
						<label>Koliko je <?php echo $a; ?> + <?php echo $b; ?>?</label>
				...
				<div class="footer-links">
					<div class="footer-col">
						...
						<div class="footer-sub">
							<p class="footer-label">Pravna i poslovna adresa</p>
	...
	<div class="rg-modal" id="projectModal" aria-hidden="true">
		...
		<div class="rg-modal__window" role="dialog" aria-modal="true">
			...
			<h3 class="rg-modal__title">Zatražite ponudu</h3>
			<p class="modal_desc">Pošaljite detalje projekta i pripremićemo ponudu u najkraćem roku</p>
			<form id="projectFormModal" class="contact-form contact-form--modal" enctype="multipart/form-data">
				<div class="contact-form__content-modal">
					<div class="contact-form__row-modal">
						<input type="text" name="name" placeholder="Ime" required pattern="^[A-Za-zА-Яа-яЁё\s]+$">
						<input type="email" name="email" placeholder="Email" required>
					</div>
					<textarea class="text_modal" name="message" placeholder="Ukratko opišite zadatak"></textarea>
					<div class="contact-form__upload">
						<label class="upload-box">
							<input type="file" name="files[]" multiple hidden accept=".zip,.jpg,.jpeg,.png,.docx,.xlsx,.pdf,.dxf,.dwg">
							<div class="upload-icon">
								<img src="/img/upload.svg" alt="Otpremanje fajla" width="48" height="48">
							</div>
							<div class="upload-text">
								<p class="upload-title">Dodajte tehnički crtež</p>
								<p class="upload-sub">Kliknite da izaberete fajl</p>
					...
					<input type="text" name="company" style="display:none" autocomplete="off">
					<button class="modal_submit_btn" type="submit">Pošaljite</button>
				</div>
	...
	const ReshagroModal = (function() {
		...
		const modalContent = {
			default: {
				...
				desc: 'Pošaljite detalje projekta i pripremićemo ponudu u najkraćem roku'
			},
			auto: {
				title: 'Imate dodatna pitanja?',
				desc: 'Ostavite upit i pružićemo vam besplatne konsultacije'
			}
		};
	...
	<script src="/js/sr/modal.js"></script>
	<script src="/js/sr/form.js"></script>
</body>
</html>