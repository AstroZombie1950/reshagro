...
<head>
	...
	<title>Токарная и фрезерная обработка металла на заказ | Reshagro Engineering Center</title>
	<meta name="description" content="Токарная и фрезерная обработка металлов и пластмасс на заказ. Изготовление деталей по чертежам, серийное и единичное производство, инженерные консультации. Работаем по всей Европе.">
	<meta name="keywords" content="токарная обработка, фрезерная обработка, металлообработка на заказ, изготовление деталей, ЧПУ, CNC machining, производство деталей">
	<meta name="author" content="Reshagro Engineering Center">
	<meta name="robots" content="index, follow">
	<meta name="theme-color" content="#0e5fa8">
	<!-- Canonical -->
	<link rel="canonical" href="https://reshagro.com/ru/">
	<!-- Open Graph -->
	<meta property="og:type" content="website">
	<meta property="og:title" content="Токарная и фрезерная обработка металла на заказ | Reshagro">
	<meta property="og:description" content="Высокоточная механическая обработка деталей по чертежам. Серийное и единичное производство.">
	...
	<meta name="twitter:title" content="Токарная и фрезерная обработка металла на заказ | Reshagro">
	<meta name="twitter:description" content="Высокоточная механическая обработка деталей по чертежам.">
...
<body>
		...
		<div class="container">
			<div class="header__inner">
				...
				<nav class="nav" id="nav">
					...
					<a href="#equipment" class="nav__link">Оборудование</a>
					<a href="#services" class="nav__link">Услуги</a>
					<a href="#projects" class="nav__link">Наши работы</a>
					<button class="btn btn-primary btn-nav" id="openModal">Рассчитать стоимость</button>
				</nav>
				...
				<button class="btn btn-primary btn-head" id="openModal">Рассчитать стоимость</button>
			</div>
		</div>
	</header>
	<!-- hero -->
			...
			<div class="stats__grid">
				<div class="stats__card">
					...
					<div class="stats__content">
						<p class="stats__label">Работаем с</p>
						<h3>2018 ГОДА</h3>
					</div>
				</div>
				<div class="stats__card">
					...
					<div class="stats__overlay"></div>
					<div class="stats__content">
						<p class="stats__label">Средний опыт специалистов</p>
						<h3>15 ЛЕТ</h3>
					</div>
				</div>
				<div class="stats__card">
					...
					<div class="stats__overlay"></div>
					<div class="stats__content">
						<p class="stats__label">Становятся постоянными</p>
						<h3>75% КЛИЕНТОВ</h3>
					</div>
				</div>
				<div class="stats__card">
					...
					<div class="stats__overlay"></div>
					<div class="stats__content">
						<p class="stats__label">В наличии более</p>
						<h3>45 ЕД. ОБОРУДОВАНИЯ</h3>
					</div>
				</div>
				<div class="stats__card">
					...
					<div class="stats__overlay"></div>
					<div class="stats__content">
						<p class="stats__label">Выполнено более</p>
						<h3>1000 ЗАКАЗОВ</h3>
					</div>
				</div>
			</div>
	...
	<section class="equipment reveal" id="equipment">
		...
		<div class="equipment__header">
			<div class="container_eq">
				<h2 class="equipment__heading">ОБОРУДОВАНИЕ</h2>
			</div>
		</div>
		...
		<div class="equipment__content">
			<div class="container equipment__content-inner">
				<div class="equipment__text">
					<h3>
						ИЗГОТОВЛЕНИЕ ПО ВАШИМ ЧЕРТЕЖАМ<br>
						ИЛИ ОБРАЗЦАМ
					</h3>
					<p>
						Вы можете предоставить нам металлоизделие и заказать изготовление дубликата.
						Мы проведём все необходимые замеры, составим чертёж и изготовим нужную деталь.
					</p>
				</div>
		...
		<div class="container">
			...
			<div class="services__grid">
				...
				<div class="service-card--6">
					...
					<p>Разработка и реализация нестандартных задач.</p>
		...
		<div class="container">
			<div class="work-types__grid">
				<div class="work-types__content">
					<h2 class="t30 fw7 mb2">Виды фрезерных работ</h2>
					<p class="t16 mb3">Фрезерные работы используются для обработки различных поверхностей и выполнения широкого спектра операций:</p>
					<ul class="work-types__list mb3">
						<li>Обработка плоских поверхностей;</li>
						<li>Создание пазов и канавок;</li>
						<li>Изготовление уступов;</li>
						<li>Формирование фасонных поверхностей;</li>
						<li>Нарезание резьбы;</li>
						<li>Изготовление зубчатых колёс.</li>
					</ul>
					<p class="t16 mb2">Для выполнения этих операций применяются разные виды фрез:</p>
					<ol class="work-types__list work-types__list--numbered">
						<li><strong>Цилиндрические</strong> — для обработки плоских поверхностей;</li>
						<li><strong>Торцевые</strong> — для фрезерования плоскостей и уступов;</li>
						<li><strong>Дисковые</strong> — для выборки пазов и резки металла;</li>
						<li><strong>Концевые</strong> — универсальный тип для различных операций;</li>
						<li><strong>Угловые</strong> — для обработки наклонных поверхностей;</li>
						<li><strong>Фасонные</strong> — для создания поверхностей сложной формы.</li>
					</ol>
					<p class="t16 mb2">Выбор типа фрезы напрямую зависит от характера выполняемых работ и требуемой точности обработки.</p>
				</div>
	...
	<section class="projects ba-block reveal" id="projects">
		<div class="container">
			...
			<div class="projects-slider">
				<button class="projects-arrow projects-arrow--prev" aria-label="Назад">
				...
				<button class="projects-arrow projects-arrow--next" aria-label="Вперёд">
					<svg viewBox="0 0 24 24" width="28" height="28">
				...
				<div class="footer-links">
					<div class="footer-col">
						...
						<div class="footer-sub">
							<p class="footer-label">Юридический и фактический адрес</p>
							<p>г. Белград,<br>ул. Улица, 55</p>
							<p class="footer-label">Почта</p>
							<p>
	...
	<div class="rg-modal" id="projectModal" aria-hidden="true">
		...
		<div class="rg-modal__window" role="dialog" aria-modal="true">
			...
			<p class="modal_desc">Пришлите детали задачи, и мы подготовим расчёт стоимости в кратчайшие сроки</p>
			<form id="projectFormModal" class="contact-form contact-form--modal" enctype="multipart/form-data">
				<div class="contact-form__content-modal">
					<div class="contact-form__row-modal">
						<input type="text" name="name" placeholder="Имя" required pattern="^[A-Za-zА-Яа-яЁё\s]+$">
						<input type="email" name="email" placeholder="Email" required>
					</div>
					...
					<input type="text" name="company" style="display:none" autocomplete="off">
					<button class="modal_submit_btn" type="submit">Отправить</button>
				</div>
