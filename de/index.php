...
<head>
	...
	<title>CNC-Drehen & Fräsen nach Zeichnung | Präzisionsfertigung | Reshagro Engineering Center</title>
	<meta name="description" content="CNC-Drehen und CNC-Fräsen von Metall- und Kunststoffteilen nach technischer Zeichnung. Einzel- und Serienfertigung, Prototypenbau sowie technische Beratung. Europaweite Zusammenarbeit.">
	<meta name="keywords" content="CNC Drehen, CNC Fräsen, Lohnfertigung Metall, Präzisionsteile, Zerspanungstechnik, CNC Bearbeitung, Prototypenfertigung, Serienfertigung">
	<meta name="author" content="Reshagro Engineering Center">
	<meta name="robots" content="index, follow">
	<meta name="theme-color" content="#0e5fa8">
	<!-- Canonical -->
	<link rel="canonical" href="https://reshagro.com/de/">
	<!-- Hreflang -->
	...
	<meta property="og:title" content="CNC-Drehen & Fräsen | Reshagro">
	<meta property="og:description" content="Präzise CNC-Bearbeitung von Metall- und Kunststoffteilen nach Zeichnung. Einzel- und Serienfertigung.">
	<meta property="og:url" content="https://reshagro.com/de/">
	<meta property="og:image" content="https://reshagro.com/img/logo_ogimg.png">
	<meta property="og:locale" content="de_DE">
	<!-- Twitter Card -->
	<meta name="twitter:card" content="summary_large_image">
	<meta name="twitter:title" content="CNC-Drehen & Fräsen | Reshagro">
	<meta name="twitter:description" content="Hochpräzise CNC-Bearbeitung nach technischer Zeichnung.">
...
<body>
		...
		<div class="container">
			<div class="header__inner">
				...
				<nav class="nav" id="nav">
					...
					<a href="#equipment" class="nav__link">Maschinenpark</a>
					<a href="#services" class="nav__link">Leistungen</a>
					<a href="#projects" class="nav__link">Unsere Projekte</a>
					<button class="btn btn-primary btn-nav" id="openModal">Angebot anfordern</button>
				</nav>
				...
				<button class="btn btn-primary btn-head" id="openModal">Angebot anfordern</button>
			</div>
		</div>
	</header>
	<!-- hero -->
	<section class="hero" id="about">
		...
		<div class="container">
			<div class="hero__content hero__content--animate">
				<h1 class="hero__title">Dreh- und Fräsbearbeitung von Metall nach Kundenanforderung</h1>
				<div class="hero__underline"></div>
				<p class="hero__text">Reshagro bietet seinen Kunden CNC-Fräsbearbeitung von Metall nach individuellen Anforderungen.<br>An unseren Produktionsstandorten stehen sowohl konventionelle als auch CNC-gesteuerte Fräsmaschinen zur Verfügung. Es werden horizontale und vertikale Fräsarbeiten mit einer Genauigkeit bis IT6 durchgeführt. Wir verarbeiten Baustähle, Nichteisenmetalle sowie Edelstahl. Hochpräzise mechanische Bearbeitung von Bauteilen nach technischen Zeichnungen. Serien- und Einzelfertigung für Industrieunternehmen und Privatkunden.</p>
			</div>
		</div>
	</section>
	<!-- adv -->
			...
			<div class="stats__grid">
				<div class="stats__card">
					...
					<div class="stats__content">
						<p class="stats__label">Am Markt seit</p>
						<h3>2018</h3>
					</div>
				</div>
				<div class="stats__card">
					...
					<div class="stats__overlay"></div>
					<div class="stats__content">
						<p class="stats__label">Durchschnittliche Berufserfahrung</p>
						<h3>15 JAHRE</h3>
					</div>
				</div>
				<div class="stats__card">
					...
					<div class="stats__overlay"></div>
					<div class="stats__content">
						<p class="stats__label">Werden Stammkunden</p>
						<h3>75% DER KUNDEN</h3>
					</div>
				</div>
				<div class="stats__card">
					...
					<div class="stats__overlay"></div>
					<div class="stats__content">
						<p class="stats__label">Mehr als</p>
						<h3>45 MASCHINEN</h3>
					</div>
				</div>
				<div class="stats__card">
					...
					<div class="stats__content">
						<p class="stats__label">Mehr als</p>
						<h3>1000 AUFTRÄGE REALISIERT</h3>
					</div>
				</div>
			</div>
		</div>
	...
	<section class="equipment reveal" id="equipment">
		...
		<div class="equipment__header">
			<div class="container_eq">
				<h2 class="equipment__heading">MASCHINENPARK</h2>
			</div>
		</div>
		...
		<div class="equipment__content">
			<div class="container equipment__content-inner">
				<div class="equipment__text">
					<h3>
						FERTIGUNG NACH IHREN ZEICHNUNGEN<br>
						ODER MUSTERN
					</h3>
					<p>
						Sie können uns ein Metallbauteil zur Verfügung stellen und die Anfertigung eines Duplikats beauftragen.
						Wir führen alle erforderlichen Messungen durch, erstellen eine technische Zeichnung und fertigen das benötigte Bauteil.
					</p>
				</div>
				<div class="equipment__cta">
					<button class="btn btn-primary">KOSTEN<br>ANFRAGEN</button>
				</div>
			</div>
		</div>
	</section>
	...
	<section class="services services--animate reveal" id="services">
		<div class="container">
			<h2 class="services__title">LEISTUNGEN</h2>
			<div class="services__grid">
				<div class="service-card service-card--1">
					<div class="service-card__bg"></div>
					<h3>Dreh- und Fräsbearbeitung von Metallen und Kunststoffen</h3>
					<p>Hochpräzise mechanische Bearbeitung auf modernen Maschinen.</p>
					<button class="btn btn-primary">ab 10 € pro Stk.</button>
				</div>
				<div class="service-card service-card--2">
					<div class="service-card__bg"></div>
					<h3>Fertigung von Bauteilen nach Zeichnung</h3>
					<p>Produktion gemäß Ihren technischen Vorgaben und Mustern.</p>
					<button class="btn btn-primary">ab 5 € pro Stk.</button>
				</div>
				<div class="service-card service-card--3">
					<div class="service-card__bg"></div>
					<h3>Serien- und Einzelfertigung</h3>
					<p>Herstellung von Bauteilserien in beliebiger Stückzahl.</p>
					<button class="btn btn-primary">ab 15 € pro Stk.</button>
				</div>
				<div class="service-card service-card--4">
					<div class="service-card__bg"></div>
					<h3>Engineering- und technische Beratung</h3>
					<p>Auswahl optimaler Lösungen und projektbegleitende Unterstützung.</p>
					<button class="btn btn-primary">ab 12 € pro Stk.</button>
				</div>
				<div class="service-card service-card--5">
					<div class="service-card__bg"></div>
					<h3>Montage- und Sekundäroperationen</h3>
					<p>Umfassende Weiterverarbeitung und Vorbereitung von Baugruppen.</p>
					<button class="btn btn-primary">ab 8 € pro Stk.</button>
				</div>
				<div class="service-card--6">
					<div class="service-card__bg"></div>
					<h3>Individuelle Anfrage</h3>
					<p>Entwicklung und Umsetzung kundenspezifischer Lösungen.</p>
		...
		<div class="container">
			<div class="work-types__grid">
				<div class="work-types__content">
					<h2 class="t30 fw7 mb2">Arten von Fräsarbeiten</h2>
					<p class="t16 mb3">Fräsarbeiten werden zur Bearbeitung verschiedener Oberflächen und zur Durchführung eines breiten Spektrums an Operationen eingesetzt:</p>
					<ul class="work-types__list mb3">
						<li>Bearbeitung ebener Flächen;</li>
						<li>Herstellung von Nuten und Schlitzen;</li>
						<li>Fertigung von Absätzen;</li>
						<li>Formgebung profilierter Oberflächen;</li>
						<li>Gewindeschneiden;</li>
						<li>Herstellung von Zahnrädern.</li>
					</ul>
					<p class="t16 mb2">Für diese Arbeiten kommen unterschiedliche Fräswerkzeuge zum Einsatz:</p>
					<ol class="work-types__list work-types__list--numbered">
						<li><strong>Zylinderfräser</strong> — zur Bearbeitung ebener Flächen;</li>
						<li><strong>Planfräser</strong> — zum Fräsen von Ebenen und Absätzen;</li>
						<li><strong>Scheibenfräser</strong> — zum Nutenfräsen und Trennen von Metall;</li>
						<li><strong>Schaftfräser</strong> — universell einsetzbar für verschiedene Operationen;</li>
						<li><strong>Winkel­fräser</strong> — zur Bearbeitung geneigter Flächen;</li>
						<li><strong>Formfräser</strong> — zur Herstellung komplexer Profilformen.</li>
					</ol>
					<p class="t16 mb2">Die Wahl des Fräswerkzeugs hängt direkt von der Art der Bearbeitung und der geforderten Präzision ab.</p>
				</div>
	...
	<section class="projects ba-block reveal" id="projects">
		<div class="container">
			<h2 class="t30 fw7 mb3">Unsere Projekte</h2>
			<!-- ===== Desktop Slider ===== -->
			<div class="projects-slider">
				<button class="projects-arrow projects-arrow--prev" aria-label="Zurück">
				...
				<button class="projects-arrow projects-arrow--next" aria-label="Weiter">
					<svg viewBox="0 0 24 24" width="28" height="28">
	...
	<section class="contact reveal">
		<div class="container">
			<h2 class="section-title contact__title">Projekt zur Kalkulation senden</h2>
					...
					<div class="contact-form__upload">
						<label class="upload-box">
							...
							<div class="upload-text">
								<p class="upload-title">Technische Zeichnung hinzufügen</p>
								<p class="upload-sub">Klicken Sie hier, um eine Datei auszuwählen</p>
							</div>
						</label>
						<div class="file-list"></div>
						<div class="warning">
							<p class="warning-text">Es können maximal 10 Dateien hochgeladen werden.</p>
						</div>
					</div>
					<textarea name="message" placeholder="Beschreiben Sie Material, Umfang, Stückzahl und Details"></textarea>
					<div class="contact-form__captcha">
						<label>Wie viel ist <?php echo $a; ?> + <?php echo $b; ?>?</label>
				...
				<div class="footer-links">
					<div class="footer-col">
						...
						<div class="footer-sub">
							<p class="footer-label">Rechtliche und tatsächliche Adresse</p>
	...
	<div class="rg-modal" id="projectModal" aria-hidden="true">
		...
		<div class="rg-modal__window" role="dialog" aria-modal="true">
			...
			<h3 class="rg-modal__title">Angebot anfordern</h3>
			<p class="modal_desc">Senden Sie uns die Details Ihrer Anfrage, und wir erstellen kurzfristig ein individuelles Angebot</p>
			<form id="projectFormModal" class="contact-form contact-form--modal" enctype="multipart/form-data">
				<div class="contact-form__content-modal">
					<div class="contact-form__row-modal">
						<input type="text" name="name" placeholder="Name" required pattern="^[A-Za-zА-Яа-яЁё\s]+$">
						<input type="email" name="email" placeholder="E-Mail" required>
					</div>
					<textarea class="text_modal" name="message" placeholder="Beschreiben Sie Ihre Anfrage kurz"></textarea>
					<div class="contact-form__upload">
						<label class="upload-box">
							<input type="file" name="files[]" multiple hidden accept=".zip,.jpg,.jpeg,.png,.docx,.xlsx,.pdf,.dxf,.dwg">
							<div class="upload-icon">
								<img src="/img/upload.svg" alt="Datei hochladen" width="48" height="48">
							</div>
							<div class="upload-text">
								<p class="upload-title">Technische Zeichnung hinzufügen</p>
								<p class="upload-sub">Klicken Sie hier, um eine Datei auszuwählen</p>
					...
					<input type="text" name="company" style="display:none" autocomplete="off">
					<button class="modal_submit_btn" type="submit">Senden</button>
				</div>
	...
	const ReshagroModal = (function() {
		...
		const modalContent = {
			default: {
				...
				desc: 'Senden Sie uns die Details Ihrer Anfrage, und wir erstellen kurzfristig ein individuelles Angebot'
			},
			auto: {
				title: 'Haben Sie noch Fragen?',
				desc: 'Senden Sie uns eine Anfrage, und wir beraten Sie kostenlos'
			}
		};
	...
	<script src="/js/de/modal.js"></script>
	<script src="/js/de/form.js"></script>
</body>
</html>